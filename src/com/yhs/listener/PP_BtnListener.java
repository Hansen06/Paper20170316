...
public class PP_BtnListener implements ActionListener {
	...
	public static List<String> getPipeiWord_() {
		return pipeiWord_;
	}

	public static void setPipeiWord_(List<String> pipeiWord_) {
		PP_BtnListener.pipeiWord_ = pipeiWord_;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		pipeiWord_ = CP_BtnListener.getPipeiWord();
		...
		for(int i = 0;i < matchedWord.size();i++){
			...
			pipeiWord_.add(matchedWord.get(i));//将关键词加入匹配链表
